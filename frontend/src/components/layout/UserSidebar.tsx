...
// Simplified menu items for general users
const userMenuItems = [
  { label: "Dashboard", icon: "fas fa-home", href: "/user-dashboard", type: "main" },
  { label: "My Profile", icon: "fas fa-user", href: "/profile", type: "main" },
  { label: "My Events", icon: "fas fa-calendar", href: "/events", type: "main" },
  { label: "My Groups", icon: "fas fa-layer-group", href: "/groups", type: "main" },
  { label: "My Family", icon: "fas fa-house-user", href: "/families", type: "main" },
  { label: "My Attendance", icon: "fas fa-clipboard-check", href: "/attendance", type: "main" },
  { label: "Settings", icon: "fas fa-cog", href: "/settings", type: "main" },
];

// Helper function to get menu items by type
const getMenuItemsByType = (type: string) => {
  return userMenuItems.filter(item => item.type === type);
};
        ...
        <div className="flex items-center justify-center h-24 border-b flex-shrink-0" style={{ borderColor: getBorderColor() }}>
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: getTextColor() }}>Member Portal</p>
            </div>
          </div>
        </div>
